                        ...
                        <div class="card-body p-0">
                            <div class="p-5">
                                ...
                                <div class="mySlides">
                                    <div class="text-center">
                                        ...
                                        <label class="choose_taital"><span
                                                class="badge rounded-pill bg-info">บันทึกความรู้สึก</span></label><br><br>
                                ...
                                <div class="mySlides">
                                    ...
                                    <textarea name="v4" id="v4" class="form-control" rows="5" placeholder="อะไรทำให้คุณรู้สึกอย่างนั้น"></textarea>
